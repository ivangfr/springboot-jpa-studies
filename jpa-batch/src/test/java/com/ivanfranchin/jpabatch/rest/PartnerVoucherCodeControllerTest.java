...
class PartnerVoucherCodeControllerTest extends AbstractTestcontainers {
  ...
  void testGetPartner() {
    ...
    ResponseEntity<PartnerResponse> responseEntity =
        testRestTemplate.getForEntity(url, PartnerResponse.class);
  ...
  void testDeletePartner() {
    ...
    String url = String.format(API_PARTNERS_PARTNER_ID_URL, partner.getId());
    ResponseEntity<PartnerResponse> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.DELETE, null, PartnerResponse.class);
  ...
  void testInsertVoucherCodes() {
    Partner partner = partnerRepository.save(getDefaultPartner());
    CreateVoucherCodeRequest createVoucherCodeRequest =
        new CreateVoucherCodeRequest(Set.of("111", "112", "113"));

    String url = String.format(API_PARTNERS_PARTNER_ID_INSERT_VOUCHER_CODES_URL, partner.getId());
    ResponseEntity<Integer> responseEntity =
        testRestTemplate.postForEntity(url, createVoucherCodeRequest, Integer.class);
  ...
  void testGetStreamVoucherCodes() {
    ...
    String url =
        String.format(API_PARTNERS_PARTNER_ID_GET_STREAM_VOUCHER_CODES_URL, partner.getId());
  ...
  void testSoftDeleteOldVoucherCodes() {
    ...
    String url =
        String.format(API_PARTNERS_PARTNER_ID_SOFT_DELETE_OLD_VOUCHER_CODES_URL, partner.getId());
    ResponseEntity<Integer> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.PUT, null, Integer.class);
  ...
  void testHardDeleteOldVoucherCodes() {
    ...
    String url =
        String.format(API_PARTNERS_PARTNER_ID_HARD_DELETE_OLD_VOUCHER_CODES_URL, partner.getId());
    ResponseEntity<Integer> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.DELETE, null, Integer.class);
  ...
  private void persistPartnerVoucherCodes(Partner partner, List<String> codes) {
    List<VoucherCode> voucherCodes =
        codes.stream().map(code -> new VoucherCode(partner, code)).collect(Collectors.toList());
  ...
  private static final String API_PARTNERS_PARTNER_ID_INSERT_VOUCHER_CODES_URL =
      "/api/partners/%s/insertVoucherCodes";
  private static final String API_PARTNERS_PARTNER_ID_SOFT_DELETE_OLD_VOUCHER_CODES_URL =
      "/api/partners/%s/softDeleteOldVoucherCodes";
  private static final String API_PARTNERS_PARTNER_ID_HARD_DELETE_OLD_VOUCHER_CODES_URL =
      "/api/partners/%s/hardDeleteOldVoucherCodes";
  private static final String API_PARTNERS_PARTNER_ID_GET_STREAM_VOUCHER_CODES_URL =
      "/api/partners/%s/getStreamVoucherCodes";
}
