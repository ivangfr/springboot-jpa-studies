...
class VoucherCodeServiceTest {
    ...
    @MockitoBean
    private VoucherCodeBatchProcessing voucherCodeBatchProcessing;
    ...
    void deleteVoucherCodesShouldDeleteInBatchesOfBatchSize() {
        ...
        ArgumentCaptor<List<VoucherCode>> captor = ArgumentCaptor.forClass((Class<List<VoucherCode>>) (Class<?>) List.class);
