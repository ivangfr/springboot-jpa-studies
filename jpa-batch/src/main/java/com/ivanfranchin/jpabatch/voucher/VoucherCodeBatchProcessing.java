...
2. In the saveVoucherCodes method of the VoucherCodeService class:
...
@Service
public class VoucherCodeBatchProcessing {
        ...
        connection -> {
          ...
          try (PreparedStatement ps =
            ...
            for (VoucherCode voucherCode : voucherCodes) {
              ...
              ps.setBoolean(2, voucherCode.isDeleted());
            ...
            log.info(
                "Batch insertion has managed to process {} entries", e.getUpdateCounts().length);
            throw e;
          }
        });
    return voucherCodes;
